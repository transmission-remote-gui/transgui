...
type
  TVarList = class;
    ...
    TCompareVarRowsEvent = function (Sender: TVarList; Row1, Row2: PVariant; DescendingSort: boolean
                           ): integer of object;
  ...
  { TVarList }
    ...
    TVarList = class(TList)
      ...
      public
        ...
        property Items[ACol, ARow: integer]: variant read GetItems write SetItems;
        default;
        ...
        property OnCompareVarRows: TCompareVarRowsEvent read FOnCompareVarRows write
                                   FOnCompareVarRows;
