...
Connection options=Επιλογές σύνδεσης
Days=Ημέρες
Delete=Διαγραφή
...
Proxy=Proxy
Refresh interval when minimized=Διάστημα ανανέωσης σε κατάσταση ελαχιστοποίησης
...
The blocklist URL was not specified=Δεν καθορίστηκε URL της λίστας αποκλεισμού
...
Modify trackers=Τροποποίση ιχνηλατών
...
User interface scaling=Κλίμακα διεπαφής χρήστη
View=Προβολή
