...
Added on=Añadido el
All=Todo
Are you sure to remove torrent '%s' and all associated DATA?=¿Estás seguro de querer eliminar el torrent '%s' y todos los DATOS asociados?
Are you sure to remove torrent '%s'?=¿Estás seguro de querer eliminar el torrent '%s'?
...
Connecting to demonio=Connectando con el demonio
...
Torrent verification may take a long time.~Are you sure to start verification of torrent '%s'?=Verificar el torrent puede tomar bastante tiempo..~¿Estás segudor de que quieres iniciar la verificación del torrent '%s'?
Torrent=Torrent
