...
Queue=Cola
Torrents that are idle for N minutes aren't counted toward the Download queue or Upload queue=Los torrents que están inactivos durante N minutos no se contabilizan en la cola de descarga o subida
...
%dmo=%d mes(es)
%dy=%d año(s)
Big Toolbar=Barra de herramientas grande
