...
Connect to daemon=Падлучыцца да Transmission
connected=падлучаны
Connecting to daemon=Падлучэньне да дэману Transmission
Connection error occurred=Памылка падлучэньня
Connection=Назва падлучэньня
Copy=Капіяваць
Country=Краіна
Created on=Створаны
D: %s/s=Загр: %s/с
Delete host settings=Выдаліць налады хосту
...
Download dir=Тэчка для запампоўкі
...
Password=Пароль
Paths=Шляхі
Pick random port on daemon launch=Кожным разам выпадковы порт
...
Refresh interval=Інтэрвал абнаўленьня
Remaining=Засталося
...
Show parameters window when adding a new torrent=Адлюстроўваць вакенца з парамэтрамі падчас даданьня торэнту
Show=Паказаць
Size=Памер
skip=прапусьціць
...
Unable to find path mapping.~Use program's options to setup path mappings=Немагчыма знайсьці супастаўленьне шляхоў.~Скарыстайцеся наладамі праграмы, каб вызначыць супастаўленьне.
...
Uploaded=Аддадзена
Use proxy server=Выкарыстоўваць проксі-сэрвэр
...
MB=МБ
TB=ТБ
You should restart the application to apply changes=Неабходна перазапусьціць праграму, каб скарыстацца зьменамі.
No host name specified=Не вызначаны вузел.
No proxy server specified=Не вызначаны проксі-сэрвэр.
Language=мова
No tracker=Няма трэкеру
Tracker did not respond=Трэкер не адказвае
...
Connection options=Парамэтры злучэньня
Days=Дзён
Delete=Выдаліць
...
Proxy=Проксі-сэрвэр
Refresh interval when minimized=Інтэрвал абнаўленьня ў згорнутым стане
...
The blocklist URL was not specified=Ня вызначаны URL сьпісу блакіровак
...
User interface scaling=Масштабаваньне інтэрфэйсу
View=Выгляд
