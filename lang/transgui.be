...
Queue=Чарга
Torrents that are idle for N minutes aren't counted toward the Download queue or Upload queue=Торэнты, што былі неактыўныя N хвілін ня ўлічваюцца ў чарзе запампоўкі ці аддачы
...
%dmo=%dмес
%dy=%dг
Access violation=Парушэньне доступу
Always auto-reconnect=Заўсёды аўтаматычна перападключацца
Application Options (Ctrl+F9)=Парамэтры прыкладаньня (Ctrl+F9)
Big Toolbar=Вялікая панэль інструмэнтаў
Client Certificate=Сэртыфікат кліента
Connection refused=У злучэньні адмоўлена
Connection timed out=Час чаканьня злучэньня скончыўся
Copy Magnet Link(s)=Капіяваць Magnet-спасылку(і)
Default=Па змаўчаньні
Delete destination folder=Выдаліць мэтавую папку
Development site=Сайт распрацоўкі
Done: %s=Завершана: %s
Export settings=Экспартаваць налады
Host not found=Хост не знойдзены
Import settings=Імпартаваць налады
Left->Right=Зьлева направа
Magnet Link=Magnet-спасылка
Menu=Мэню
Other Winsock error=Іншая памылка Winsock
Private Key=Прыватны ключ
Remaining: %s=Засталося: %s
Right->Left=Справа налева
Right->Left (No Align)=Справа налева (без выраўноўваньня)
Right->Left (Reading Only)=Справа налева (толькі чытаньне)
Selected: %s=Выбрана: %s
Size left=Засталося памеру
Status bar - Sizes=Радок стану - Памеры
Template:  =Шаблон:
The maximum history of directories for storage of torrents=Максімальная гісторыя папак для захоўваньня торэнтаў
Toolbar=Панэль інструмэнтаў
Total: %s=Усяго: %s
