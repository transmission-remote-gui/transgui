...
Password=Wachtwoord
Paths=Paden
Pick random port on daemon launch=Kies een willekeurige poort als daemon opstart
...
Delete a .torrent file after after a successful addition=.torrent bestand verwijderen na succesvol toevoegen
Torrent=Torrent
...
The blocklist URL was not specified=De Blocklist URL is niet gespecificeerd
