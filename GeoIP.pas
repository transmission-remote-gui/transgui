...
const
  CountryCodes: array [0..252] of string = ('--','AP','EU','AD','AE','AF','AG','AI','AL','AM','AN',
                                            ...
                                            'TF','TG','TH','TJ','TK','TM','TN','TO','TL','TR','TT',
                                            'TV','TW','TZ','UA','UG','UM','US','UY','UZ','VA','VC',
                                            'VE','VG','VI','VN','VU','WF','WS','YE','YT','RS','ZA',
                                            'ZM','ME','ZW','A1','A2','O1','AX','GG','IM','JE','BL',
                                            'MF');

  CountryNames: array [0..252] of string = ('N/A','Asia/Pacific Region','Europe','Andorra',
                                            ...
                                            'Bahrain','Burundi','Benin','Bermuda',
                                            'Brunei Darussalam','Bolivia','Brazil','Bahamas',
                                            ...
                                            'Cote D''Ivoire','Cook Islands','Chile','Cameroon',
                                            ...
                                            ,'Haiti','Hungary','Indonesia','Ireland',
                                            'Israel','India','British Indian Ocean Territory','Iraq'
                                            ...
                                            'Libyan Arab Jamahiriya','Morocco','Monaco',
                                            ...
                                            'Timor-Leste','Turkey','Trinidad and Tobago','Tuvalu',
                                            ...
                                            'Mayotte','Serbia','South Africa','Zambia','Montenegro',
                                            'Zimbabwe','Anonymous Proxy','Satellite Provider',
                                            'Other','Aland Islands','Guernsey','Isle of Man',
...
var
  ...
  p: PChar;
begin
  if (FDatabaseType <> GEOIP_ORG_EDITION) and (FDatabaseType <> GEOIP_ISP_EDITION) and (
...
var
  SeekRegion: Cardinal;
begin
  if (FDatabaseType <> GEOIP_REGION_EDITION_REV0) and (FDatabaseType <> GEOIP_REGION_EDITION_REV1)
    then
    begin
      Result := GEOIP_ERROR_DBTYPE;
      Exit;
    ...
    begin
      ...
      if SeekRegion >= 1000 then
        begin
          ...
          GeoIPRegion.Region := Chr((SeekRegion - 1000) div 26 + 65) + Chr((SeekRegion - 1000) mod
                               26 + 65);
        end
      else
        begin
             ...
             begin
               ...
               GeoIPRegion.Region := '';
                  ...
                  begin
                    // USA State
                    GeoIPRegion.CountryCode := 'US';
                    GeoIPRegion.Region := Chr((SeekRegion - US_OFFSET) div 26 + 65) + Chr((
                                         SeekRegion - US_OFFSET) mod 26 + 65);
                  end
           else if SeekRegion < WORLD_OFFSET then
                  begin
                    // Canada Province
                    GeoIPRegion.CountryCode := 'CA';
                    GeoIPRegion.Region := Chr((SeekRegion - CANADA_OFFSET) div 26 + 65) + Chr((
                                         SeekRegion - CANADA_OFFSET) mod 26 + 65);
                  end
           else
             begin
               // Not US or Canada
