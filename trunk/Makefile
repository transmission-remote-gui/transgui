#
# Don't edit, this file is generated by FPCMake Version 2.0.0 [2010/11/10]
#
default: all
...
ifeq ($(FULL_TARGET),i386-darwin)
override COMPILER_OPTIONS+=-MObjFPC -dLCL -dLCL$(LCL_WIDGETSET) -O2 -g- -CX -XX -Xs  -k-macosx_version_min -k10.5 -XR/Developer/SDKs/MacOSX10.5.sdk/
endif
ifeq ($(FULL_TARGET),i386-emx)
override COMPILER_OPTIONS+=-MObjFPC -dLCL -dLCL$(LCL_WIDGETSET) -O2 -g- -CX -XX -Xs
endif
