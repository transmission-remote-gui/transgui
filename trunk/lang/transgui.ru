...
Path=Путь
Reannounce (get more peers)=Анонсировать (получить польше пиров)
...
Move torrent data from current location to new location=Переместить данные торрента из текущего места в новое место
