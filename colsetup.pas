...
uses
Classes, SysUtils, FileUtil, LResources, Forms, Controls, Graphics, Dialogs, ComCtrls, CheckLst,
StdCtrls, ButtonPanel, ExtCtrls, VarGrid, BaseForm;
...
begin
  ...
  btDown.Enabled :=(lstColumns.ItemIndex >= 0) and (lstColumns.ItemIndex < lstColumns.Items.Count -
                   1);
end;
